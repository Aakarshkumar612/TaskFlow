/**
 * Login Form Component - Clerk Integration Placeholder
 *
 * This component will be replaced by Clerk's pre-built Sign In component.
 * Currently redirects to dashboard since auth is not required.
 *
 * TODO: When Clerk is integrated:
 * - Install @clerk/clerk-react
 * - Replace with <SignIn /> component from Clerk
